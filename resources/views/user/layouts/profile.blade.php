    ...
    <form>
      <div class="flex items-center justify-between mb-4 pb-4 border-b">
          ...
          <div class="text-right">
              <button class="bg-blue-600 hover:bg-blue-700 text-white text-xs py-2 px-7 rounded focus:shadow-outline shadow">
                  ویرایش 
              </button>
          </div>
      </div>
        ...
        <div class="mb-6">
            ...
            <input type="fullname" id="fullname" value="{{ $user->fullname }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
        </div>
        <div class="mb-6">
          ...
          <input type="username" id="username" value="{{ $user->useranme }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
        </div>
        <div class="mb-6">
