        ...
        <div x-show="show" class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div x-show="show" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex justify-between items-center p-5 rounded-t border-b dark:border-gray-600">
                    ...
                    <button x-on:click="show = false" class="text-gray-400 self-start bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 mr-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="small-modal">
