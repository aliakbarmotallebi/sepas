...
<nav class="text-lg flex items-center justify-between content-center ">
    ...
    <div class="flex space-x-5 md:space-x-10 text-gray-500 items-center content-center text-base ">
        <a class="flex items-center space-x-3 px-3 py-2 rounded bg-indigo-100 ml-2" href="#">
                        <span>
        ...
        <a href="{{ route('logout') }}" class="px-3 py-2 bg-rose-400 rounded flex items-center space-x-2 text-indigo-500 hover:bg-indigo-200" href="#">
            <svg
