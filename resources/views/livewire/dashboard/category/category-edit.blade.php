...
<x-modal title="ویرایش دسته بندی" wire:model="show">
    ...
    <div class="col-span-1">
        ...
        <form wire:submit.prevent="update({{ $old_cat }})" method="POST">
            <div>
                <div>
                ...
                <div class="flex items-center justify-start pt-4 rounded-b border-t border-gray-200 dark:border-gray-600">
                    <button type="submit" wire:click.prevent="update({{ $old_cat }})" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-1.5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-1">
                        ویرایش دسته بندی
                    </button>
                    <button  type="button" 
                        wire:click="show()"
