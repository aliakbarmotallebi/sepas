...
@section('content')
    <section class="mt-4">
        ...
        <x-dashboard.cart title="لیست دوره ها" >
            ...
            <x-slot name="content">
                @if ($courses->isEmpty())
                <div class="bg-white border-b hover:bg-gray-100 w-full">
                    ...
                    <div class="mr-auto">
                        <div class="flex flex-row">
                            ...
                            <div class="flex text-center">
                                <a href="{{ route('dashboard.courses.users', $course) }}" target="_blank" class="ml-1 flex items-center p-2 text-xs font-medium text-gray-700 bg-white rounded-lg border border-gray-200 toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 focus:outline-none">
                                ...
                                <a href="{{ route('dashboard.courses.questions', $course) }}" target="_blank" class="ml-1 flex items-center p-2 text-xs font-medium text-gray-700 bg-white rounded-lg border border-gray-200 toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 focus:outline-none">
