...
@section('content')
    <section class="mt-4">
        <div>
            <a href="{{ route('dashboard.courses.index') }}" class="flex border justify-between items-center bg-white text-sky-700 hover:bg-white px-3 py-2 rounded-lg hover:text-sky-700 text-sm">
                <svg
            ...
            <x-slot name="content">
                    <div class="grid grid-cols-2 gap-x-4 gap-y-1 p-5">
                        <div class="mt-1">
                            ...
                            <input type="text" name="title" class="shadow-sm border @error('title') border-rose-400 @enderror rounded-md py-2 px-3 w-full">
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-x-4">
                            <div class="mt-1">
                                ...
                                <input type="text" name="price" class="shadow-sm border @error('price') border-theme-6 @enderror rounded-md py-2 px-3 w-full">
                            </div>
                        ...
                        <div class="mt-1 col-span-2">
                            ...
                            <textarea name="description" class="h-20 shadow-sm border @error('description') border-theme-6 @enderror rounded-md py-2 px-3 w-full" name="" id="" cols="30" rows="10"></textarea>
                        </div>
                        ...
                        <div class="mt-1">
                            ...
                            <textarea name="topics" class="h-20 shadow-sm border @error('description') border-theme-6 @enderror rounded-md py-2 px-3 w-full" name="" id="" cols="30" rows="10"></textarea>
                        </div>
                        ...
                        <div class="mt-1">
                            ...
                            <textarea name="requirements" class="h-20 shadow-sm border @error('description') border-theme-6 @enderror rounded-md py-2 px-3 w-full" name="" id="" cols="30" rows="10"></textarea>
                        </div>
